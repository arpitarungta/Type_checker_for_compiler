...
{
       0,     0,     3,     5,     7,    10,    16,    21,    25,    29,
      35,    43,    49,    55,    58,    60,    61,    66,    68,    70,
      72,    74,    78,    82,    86,    90,    93,    97,   101,   105,
     109,   113,   117,   119,   121,   123,   125,   127,   132,   136,
     138
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      81,    36,    60,    82,    66,    -1,    36,    60,    82,    66,
      -1,    81,    36,    66,    -1,    22,    82,    66,    -1,    18,
      68,    82,    69,    78,    -1,    18,    68,    82,    69,    78,
      12,    78,    -1,    34,    68,    82,    69,    78,    -1,    81,
      36,    68,    69,    79,    -1,    82,    66,    -1,    79,    -1,
      -1,    70,    80,    77,    71,    -1,    19,    -1,    15,    -1,
       6,    -1,    35,    -1,    82,    53,    82,    -1,    82,    54,
      82,    -1,    82,    55,    82,    -1,    82,    56,    82,    -1,
      54,    82,    -1,    82,    59,    82,    -1,    82,    58,    82,
      -1,    82,    43,    82,    -1,    82,    44,    82,    -1,    82,
      46,    82,    -1,    82,    45,    82,    -1,    37,    -1,    38,
      -1,    39,    -1,    42,    -1,    36,    -1,    36,    68,    83,
      69,    -1,    82,    67,    83,    -1,    82,    -1,    -1
};
...
static const char *const yytname[] =
{
  ...
  "UNSIGNED", "VOID", "VOLATILE", "WHILE", "STRING", "IDENTIFIER",
  "DEC_CONSTANT", "FLOAT_CONSTANT", "STRING_LITERAL", "HEX_CONSTANT",
  "OCT_CONSTANT", "CHAR_LITERAL", "EQ", "NEQ", "LE", "GE", "AND", "OR",
  "SHL", "SHR", "INC", "DEC", "PLUS", "MINUS", "STAR", "FW_SLASH", "MOD",
  "LT", "GT", "ASSIGN", "BITAND", "BITOR", "BITXOR", "BITNOT", "NOT",
  "DELIMITER", "COMMA", "OPEN_PAR", "CLOSE_PAR", "OPEN_BRACE",
  "CLOSE_BRACE", "OPEN_BRACKET", "CLOSE_BRACKET", "UMINUS", "$accept",
  "program", "stmt_list", "stmt", "block", "$@1", "type", "expr",
  "arg_list", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 113 "parser.y"
    { (yyval.node) = create_binary_op_node(";", (yyvsp[(1) - (2)].node), (yyvsp[(2) - (2)].node)); ;}
    break;
...
#line 117 "parser.y"
    {
        if (get_symbol((yyvsp[(2) - (5)].str))) {
            fprintf(stderr, "Semantic Error: Variable '%s' redeclared\n", (yyvsp[(2) - (5)].str));
            semantic_error_found = 1;
        }
        (yyval.node) = create_assignment_node((yyvsp[(2) - (5)].str), (yyvsp[(4) - (5)].node));
        (yyval.node)->left = create_declaration_node((yyvsp[(1) - (5)].str), (yyvsp[(2) - (5)].str), NULL);
        (yyval.node)->right->data_type = (yyvsp[(4) - (5)].node)->data_type;
        (yyval.node)->left->data_type = strdup((yyvsp[(1) - (5)].str));
        if (strcmp((yyvsp[(1) - (5)].str), (yyvsp[(4) - (5)].node)->data_type) != 0) {
            fprintf(stderr, "Semantic Error: Type mismatch in assignment to '%s' (declared as %s, assigned %s)\n",
            (yyvsp[(2) - (5)].str), (yyvsp[(1) - (5)].str), (yyvsp[(4) - (5)].node)->data_type);
            semantic_error_found = 1;
        }
        insert_symbol((yyvsp[(2) - (5)].str), (yyvsp[(1) - (5)].str), SYM_VAR);
        mark_initialized((yyvsp[(2) - (5)].str));
    ;}
    break;
...
#line 134 "parser.y"
    {
        Symbol *sym = get_symbol((yyvsp[(1) - (4)].str));
        if (!sym) {
            fprintf(stderr, "Semantic Error: '%s' not declared\n", (yyvsp[(1) - (4)].str));
            semantic_error_found = 1;
        }
        (yyval.node) = create_assignment_node((yyvsp[(1) - (4)].str), (yyvsp[(3) - (4)].node));
        (yyval.node)->left = create_identifier_node((yyvsp[(1) - (4)].str));
        (yyval.node)->left->data_type = sym ? strdup(sym->type) : strdup("unknown");
        (yyval.node)->right->data_type = (yyvsp[(3) - (4)].node)->data_type;
        mark_initialized((yyvsp[(1) - (4)].str));
    ;}
    break;
...
#line 146 "parser.y"
    {
        if (get_symbol((yyvsp[(2) - (3)].str))) {
            fprintf(stderr, "Semantic Error: Variable '%s' redeclared\n", (yyvsp[(2) - (3)].str));
            semantic_error_found = 1;
        }
        (yyval.node) = create_declaration_node((yyvsp[(1) - (3)].str), (yyvsp[(2) - (3)].str), NULL);
        insert_symbol((yyvsp[(2) - (3)].str), (yyvsp[(1) - (3)].str), SYM_VAR);
    ;}
    break;
...
#line 154 "parser.y"
    {
        (yyval.node) = create_binary_op_node("return", (yyvsp[(2) - (3)].node), NULL);
    ;}
    break;
...
#line 157 "parser.y"
    {
        (yyval.node) = create_binary_op_node("if", (yyvsp[(3) - (5)].node), (yyvsp[(5) - (5)].node));
    ;}
    break;
...
#line 160 "parser.y"
    {
        ASTNode *if_node = create_binary_op_node("if", (yyvsp[(3) - (7)].node), (yyvsp[(5) - (7)].node));
        (yyval.node) = create_binary_op_node("else", if_node, (yyvsp[(7) - (7)].node));
    ;}
    break;
...
#line 164 "parser.y"
    {
        (yyval.node) = create_binary_op_node("while", (yyvsp[(3) - (5)].node), (yyvsp[(5) - (5)].node));
    ;}
    break;
...
#line 167 "parser.y"
    {
        insert_symbol((yyvsp[(2) - (5)].str), (yyvsp[(1) - (5)].str), SYM_FUNC);
        (yyval.node) = create_binary_op_node("function", create_identifier_node((yyvsp[(2) - (5)].str)), (yyvsp[(5) - (5)].node));
    ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 177 "parser.y"
    { exit_scope(); (yyval.node) = (yyvsp[(3) - (4)].node); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 188 "parser.y"
    { (yyval.node) = create_binary_op_node("+", (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); (yyval.node)->data_type = (yyvsp[(1) - (3)].node)->data_type; ;}
    break;
...
#line 191 "parser.y"
    {
        ...
        if (strcmp((yyvsp[(3) - (3)].node)->data_type, "int") == 0 && (yyvsp[(3) - (3)].node)->type == NODE_TYPE_LITERAL && (yyvsp[(3) - (3)].node)->value.int_val == 0) {
            fprintf(stderr, "Semantic Error: Division by zero at line %d\n", yylineno);
        }
        (yyval.node)->data_type = (yyvsp[(1) - (3)].node)->data_type;
    ;}
    break;
...
#line 198 "parser.y"
    {
        (yyval.node) = create_binary_op_node("UMINUS", (yyvsp[(2) - (2)].node), NULL);
        (yyval.node)->data_type = (yyvsp[(2) - (2)].node)->data_type;
    ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 202 "parser.y"
    { (yyval.node) = create_binary_op_node(">", (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node)); (yyval.node)->data_type = strdup("int"); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 208 "parser.y"
    { (yyval.node) = create_literal_node("int", atoi((yyvsp[(1) - (1)].str)), 0, NULL); (yyval.node)->data_type = strdup("int"); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 209 "parser.y"
    { (yyval.node) = create_literal_node("float", 0, atof((yyvsp[(1) - (1)].str)), NULL); (yyval.node)->data_type = strdup("float"); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 210 "parser.y"
    { (yyval.node) = create_literal_node("string", 0, 0, (yyvsp[(1) - (1)].str)); (yyval.node)->data_type = strdup("string"); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 211 "parser.y"
    { (yyval.node) = create_literal_node("char", (int)(yyvsp[(1) - (1)].str)[1], 0, NULL); (yyval.node)->data_type = strdup("char"); ;}
    break;
...
#line 212 "parser.y"
    {
        ...
        Symbol *sym = get_symbol((yyvsp[(1) - (1)].str));
